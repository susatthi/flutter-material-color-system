...
String _$seedColorHistoryCollectionBoxHash() =>
    r'a197c0151d7605cbde3543c83ad40112fa95c4b7';

/// See also [seedColorHistoryCollectionBox].
@ProviderFor(seedColorHistoryCollectionBox)
final seedColorHistoryCollectionBoxProvider =
    AutoDisposeProvider<Box<SeedColorHistoryCollection>>.internal(
  seedColorHistoryCollectionBox,
  name: r'seedColorHistoryCollectionBoxProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$seedColorHistoryCollectionBoxHash,
  dependencies: null,
